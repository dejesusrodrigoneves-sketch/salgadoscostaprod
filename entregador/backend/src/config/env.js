...
module.exports = {
  ...
  ninefoodClientId: process.env['99FOOD_CLIENT_ID'],
  ninefoodClientSecret: process.env['99FOOD_CLIENT_SECRET'],
  ninefoodAuthorizeUrl: process.env['99FOOD_AUTHORIZE_URL'],
  ninefoodTokenUrl: process.env['99FOOD_TOKEN_URL'],
  ninefoodRevokeUrl: process.env['99FOOD_REVOKE_URL'],
  ninefoodScope: process.env['99FOOD_SCOPE'],
